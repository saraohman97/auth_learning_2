...
const SelectColor: React.FC<SelectColorProps> = ({
    ...
    }, [setFile, removeImageFromState, setIsSelected, item])

    return ( 
        <div className="grid grid-cols-1 overflow-y-auto border-b border-slate-200 items-center p-2">
